...
"background-color: rgb(236, 236, 236);")
        ...
        self.gridLayout.addWidget(self.file_path_label, 1, 0, 1, 7)
...
"background-color: rgb(77, 200, 112);")
        ...
        self.gridLayout.addWidget(self.make_booklet_button, 9, 0, 1, 7)
        ...
        self.gridLayout.addWidget(self.log_label, 8, 0, 1, 7)
        ...
        self.start_page_label_2 = QtWidgets.QLabel(self.centralwidget)
        self.start_page_label_2.setMaximumSize(QtCore.QSize(55, 20))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.start_page_label_2.setFont(font)
        self.start_page_label_2.setObjectName("start_page_label_2")
        self.gridLayout.addWidget(self.start_page_label_2, 4, 1, 1, 1)
        self.start_page_label = QtWidgets.QLabel(self.centralwidget)
        self.start_page_label.setMaximumSize(QtCore.QSize(55, 20))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.start_page_label.setFont(font)
        self.start_page_label.setObjectName("start_page_label")
        self.gridLayout.addWidget(self.start_page_label, 3, 1, 1, 1)
        self.start_page_number_label = QtWidgets.QLabel(self.centralwidget)
        self.start_page_number_label.setMaximumSize(QtCore.QSize(50, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.start_page_number_label.setFont(font)
        self.start_page_number_label.setToolTip("")
        self.start_page_number_label.setToolTipDuration(2)
        self.start_page_number_label.setObjectName("start_page_number_label")
        self.gridLayout.addWidget(self.start_page_number_label, 3, 0, 1, 1)
...
"")
        ...
        self.book_direction_combobox.addItem("")
        self.gridLayout.addWidget(self.book_direction_combobox, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.book_direction_label, 6, 0, 1, 2)
